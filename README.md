...
```sh
python -m pip install --upgrade crown_and_covenant_client-0.3.2-py3-none-any.whl
```

Or install the versioned source directly (requires Git):

```sh
python -m pip install --upgrade 'git+https://github.com/heads-and-tails/crown-and-covenant-client.git@v0.3.2'
```
